...
import com.excellence.dqube.base.XMLParserAPI;
	...
	public class BLJGoodsSelect extends BLJsonMap4DB implements IBisinessLogic {
		...
		public void setModel(IModel model){
			...
			super.pageTitle = "BLJGoodsSelect";

			super.defaultSQL = "SELECT MaterialID, MaterialName, Unit, UnitCost, ExpPeriod, Supplier, MatRemark  from Material_M where MaterialName = ?";

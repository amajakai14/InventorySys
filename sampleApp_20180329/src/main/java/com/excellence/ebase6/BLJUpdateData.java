 ...
 *
 */
public class BLJUpdateData extends BLJsonMap4DB implements IBisinessLogic {
	...
	public void setModel(IModel model){
		...
		super.pageTitle = "BLJUpdateData";

		//super.defaultSQL = "INSERT INTO ITEM_MST VALUES (?, ? ,? ,? ,? ,?)";
		super.defaultSQL = "UPDATE Material_M SET MaterialName = ?, Unit = ?, UnitCost = ?, ExpPeriod = ?,Supplier = ?, MatRemark = ? WHERE MaterialID = ?";
	...
	public boolean innerLogic(){
		...
		String expperiod = firstParam("expperiod");
		String supp = firstParam("supp");
		...
		//格納モデルをインスタンス化
				...
				try{
					...
					$pstm.setInt(4, Integer.parseInt(expperiod));
					$pstm.setString(5,supp);
					$pstm.setString(6,caution);

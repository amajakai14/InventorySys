...
import com.excellence.dqube.base.XMLParserAPI;
	...
	public class BLJPoSelect extends BLJsonMap4DB implements IBisinessLogic {
		...
		public void setModel(IModel model){
			...
			super.defaultSQL = "select p.PoNumber, m.MaterialName, m.Unit, m.UnitCost, m.ExpPeriod, m.Supplier, p.PoDate, p.DeliverDate, p.OrderQuan, p.PoRemark\n"
					...
					+ "inner join  Material_M m on p.MaterialID = m.MaterialID where PoNumber = ? ;";

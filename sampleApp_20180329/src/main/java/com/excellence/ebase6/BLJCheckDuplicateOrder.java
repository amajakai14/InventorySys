...
import com.excellence.dqube.base.XMLParserAPI;
	...
	public class BLJCheckDuplicateOrder extends BLJsonMap4DB implements IBisinessLogic {
		...
		public void setModel(IModel model){
			...
			super.pageTitle = "BLJCheckDuplicateOrder";

			super.defaultSQL = "Select count(OrderQuan) from PurchaseOrder_T where (DeliverDate = ?) and (MaterialID = ?);";
	...
	public boolean innerLogic(){
		...
		try{
			...
			$pstm.setDate(1, java.sql.Date.valueOf(scheduled));

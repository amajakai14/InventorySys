	...
	function firstpageStockCount(){
		...
		$.postJSON("DQube", { actionID: 'DaySalesbyDay2',dateselect:dateselect}, function(jres) {
			...
			$.postJSON("DQube", { actionID: 'DaySalesbyDay',dateselect:dateselect}, function(jres) {
				...
				tabledetail.appendChild(btnreturn);
				...
				var x = tabledetail.tBodies[0].rows.length;
				var hadjust = 20+30*x;
				tabledetail.style.cssText = "position:absolute;width:616px;height:"+hadjust+"px;max-height:360px;"
		...
		$.postJSON("DQube", { actionID: 'DaySalesbyDay2',dateselect:dateselect}, function(jres) {
			...
			$.postJSON("DQube", { actionID: 'DaySalesbyDay',dateselect:dateselect}, function(jres) {
				...
				var tbodyElem = document.createElement("tbody");
				tabledetail.appendChild(tbodyElem);
				tbodyElem.setAttribute("id", "dataTableInv");
				...
				var x = tabledetail.tBodies[0].rows.length;
				var hadjust = 20+30*x;
				tabledetail.style.cssText = "position:absolute;width:676px;height:"+hadjust+"px;max-height:360px;"

...
$(function(){
	...
	function firstpageOrder(){
		...
		btns.style.cssText = 'font-size:1em;padding: 5px;background-color: green;position:absolute;left:5px;top:480px;'
		$('#NewPo').off("click");
		...
		btnh.style.cssText = 'font-size:1em;padding: 5px;background-color: orange;position:absolute;left :95px;top:480px;'
		$('#PoEdit').off("click");
	...
	function orderingWork(){
		...
		select.onchange = function(){
			...
			btn.style.cssText = "position:relative;top:100px;left:600px;width:80px;background-color:#59B7EA;"
			...
			btnreturn.style.cssText = "top:300px;left:680px;width:80px;"
	...
	function getCheckedData() {
		...
		view7.style.cssText = 'position:absolute;top:0px;left:50%;border:solid 1px;min-width:100px;width:10%;background-color:grey;padding:5px;text-align:center;box-sizing: border-box;';
		view7.id = "view7_sample";

		var view8 = document.createElement("div");
		listCreateTable.appendChild(view8);
		view8.innerHTML = "発注日";
		view8.style.cssText = 'position:absolute;top:0px;left:60%;border:solid 1px;min-width:100px;width:10%;background-color:grey;padding:5px;text-align:center;box-sizing: border-box;';
		view8.id = "view8_sample";
		
		var view9 = document.createElement("div");
		listCreateTable.appendChild(view9);
		view9.innerHTML = "発注備考";
		view9.style.cssText = 'position:absolute;top:0px;left:70%;border:solid 1px;min-width:100px;width:10%;background-color:grey;padding:5px;text-align:center;box-sizing: border-box;';
		...
		for (j = 0; j < tbodyRowCount ; j++) {
			...
			if (document.getElementById(rcheck) != null) {
				...
				if (x == true) {
					...
					$.postJSON("DQube", { actionID: 'PoUpdateData', order: order, delidate: delidate, poremark: poremark, id: id }, function() {  //submit処理開始
						return false;
					});
				} 
			}
